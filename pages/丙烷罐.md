...
**来源:** https://noita.wiki.gg/zh/wiki/%E4%B8%99%E7%83%B7%E7%BD%90
---
...
**丙烷罐** 是一种投射物法术，能召唤一个泄漏出[冰冷蒸汽](冰冷蒸汽.md)并向前飞行的的**丙烷罐** ，在短时间后剧烈爆炸，产生大量冰冷蒸汽。 

## 使用技巧

  * 这个法术能造成非常高的爆炸伤害，但也可能伤害你自己，请小心行事： 
    * 破坏这个法术生成的丙烷罐或等待它自然爆炸会发生 2 次[![爆炸伤害](https://noita.wiki.gg/zh/images/Damage_Explosion_dmg-large.png?7e98eb)](/zh/wiki/%E4%BC%A4%E5%AE%B3%E7%B1%BB%E5%9E%8B#爆炸伤害 "爆炸伤害")325的爆炸[[1]](#cite_note-1)，双倍于其面板，这两次爆炸都不带有施法者信息，可以造成[技巧击杀](技巧击杀.md)。更详细的机制参见[爆炸机制](爆炸机制.md)。
    * 使用[零时](零时.md)引爆只会发生 1 次爆炸，带有施法者信息，不能造成技巧击杀。因此如果你想要造成技巧击杀，应避免与零时搭配。
    * 使用[引爆器](引爆器.md)引爆只会发生 1 次爆炸，但不带有施法者信息。
    * 天然生成的丙烷罐只会造成一次[![爆炸伤害](https://noita.wiki.gg/zh/images/Damage_Explosion_dmg-large.png?7e98eb)](/zh/wiki/%E4%BC%A4%E5%AE%B3%E7%B1%BB%E5%9E%8B#爆炸伤害 "爆炸伤害")325的爆炸，不过这也足以斩杀不足

114 ♥

的玩家，而且之后生成的冰冷蒸汽也会对玩家造成大量伤害，请小心行事。
  * 丙烷罐的撞击以及冰冷蒸汽也算作技巧击杀。综合上述两点，拥有[技巧血金](技巧血金.md)时这个法术对于获取血金相当有用，但要小心自伤。
  * [冰冷蒸汽](冰冷蒸汽.md)接触空气会缓慢消失，[气体自燃](气体自燃.md)天赋或[火球环绕](火球环绕.md)则可以方便地烧掉冰冷蒸汽并将其转化为[蒸汽](蒸汽.md)。[复仇爆炸](复仇爆炸.md)也能一定程度上消除冰冷蒸汽。
  * 配合[追踪](追踪.md)法术或[追踪法术](追踪法术.md)天赋能够使得丙烷罐向敌人加速撞去，造成相当高的冲击伤害。
  * [手持炸弹](手持炸弹.md)天赋可以直接从物品栏中释放这个法术。
  ...
  * 常用的瞬爆配置（请小心自伤）： 
        ...
        |spread=0
        |spellsCast=1
        |spells=LIGHT_BULLET_TRIGGER,BURST_2,SLOW_BULLET,PROPANE_TANK
        |alwaysCasts=
        }}
...
[法杖模拟器](https://tinker-with-wands-online.vercel.app/?a=1&c=2500&r=20&d=10&v=1&x=0&m=5000&l=4&q=0&s=LIGHT_BULLET_TRIGGER%2CBURST_2%2CSLOW_BULLET%2CPROPANE_TANK)
...
[](##)
    ...
    * 上述配置中的[能量球](能量球.md)可以更换为[电浆束](电浆束.md)等能破坏地形的法术，你甚至可以更换为[物质吞噬者](物质吞噬者.md)修正。
    * 由于丙烷罐一生成就会飞走，所以像[挖掘魔弹](挖掘魔弹.md)这样能较稳定引爆[炸药箱](召唤炸药箱.md)的小范围破坏法术在引爆丙烷罐的方面表现很差。
  * 另一种配置，由于能量球的飞行速度较慢，相对不推荐。 
        ...
        |spread=0
        |spellsCast=1
        |spells=SLOW_BULLET_TRIGGER,PROPANE_TANK
        |alwaysCasts=
        }}
...
[法杖模拟器](https://tinker-with-wands-online.vercel.app/?a=1&c=2500&r=20&d=10&v=1&x=0&m=5000&l=2&q=0&s=SLOW_BULLET_TRIGGER%2CPROPANE_TANK)
...
## 你知道吗？
  ...
  * [席西基地](席西基地.md)中可能会生成一种睡在床上的丙烷罐。
  * 丙烷罐爆炸后除了会产生[冰冷蒸汽](冰冷蒸汽.md)之外还会产生[魔法液体](魔法液体.md)，这可能是为了让爆炸特效变得更好看而故意为之。
  * 丙烷罐紫色点缀黄色的外观长得很像[米纳](米纳.md)。
  * 对于爆炸伤害，丙烷罐的面板（[![爆炸伤害](https://noita.wiki.gg/zh/images/Damage_Explosion_dmg-large.png?7e98eb)](/zh/wiki/%E4%BC%A4%E5%AE%B3%E7%B1%BB%E5%9E%8B#爆炸伤害 "爆炸伤害")325）甚至比[核弹](核弹.md)的面板（[![爆炸伤害](https://noita.wiki.gg/zh/images/Damage_Explosion_dmg-large.png?7e98eb)](/zh/wiki/%E4%BC%A4%E5%AE%B3%E7%B1%BB%E5%9E%8B#爆炸伤害 "爆炸伤害")250）还高。



## 画廊

[![](https://noita.wiki.gg/zh/images/Sleeping_propane_tank.jpg?1c5fe6)](/zh/wiki/File:Sleeping_propane_tank.jpg)

[](https://noita.wiki.gg/zh/wiki/File%3ASleeping%20propane%20tank.jpg)

*晚安*

## 历史

  * **[2024年04月08日(Epilogue2)](版本日志.md)**: 将 4 、 5 和 6 级的生成权重分别从 1.0 调整为 0.8 、 0.8 和 0.7 。



## 注释

  1. [↑](#cite_ref-1) 这是因为这个法术具有两个能造成爆炸的组件`ProjectileComponent`和`ExplodeOnDamageComponent`。
