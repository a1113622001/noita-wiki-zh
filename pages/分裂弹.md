...
**分类:** [Category:具有负数的施放延迟法术](Category%3A具有负数的施放延迟法术.md) · [Category:影响存在时间的修正](Category%3A影响存在时间的修正.md) · [Category:影响散射角度的修正](Category%3A影响散射角度的修正.md) · [Category:投射物伤害法术](Category%3A投射物伤害法术.md) · [Category:弹跳法术](弹跳法术.md) · [Category:定时法术](Category%3A定时法术.md) · [[Category:有多个法术的法术页面]] · [[Category:没有标签的法术]] · [Category:Spells](Category%3ASpells.md) · [Category:投射物法术](Category%3A投射物法术.md)
**来源:** https://noita.wiki.gg/zh/wiki/%E5%88%86%E8%A3%82%E5%BC%B9
---
...
**分裂弹** 是Noita中的一种投射物[法术](法术.md)。 

## 效果

发射一枚中等散布的飞弹，随时间推移快速缩小直到消失。能够击中中短距离的目标。 

分裂弹有三种等级，每种分裂弹都有带[定时](触发.md)的变种。更高级的分裂弹具有不同的颜色和更远的射程，但法力-伤害比显著降低。 

在无爆炸，无次数限制的投射物法术中，普通的分裂弹是法力-伤害比第二好的法术，略低于第一名[巨型碟状投射物](巨型碟状投射物.md)。 

## 使用技巧

  * 单个分裂弹的伤害较低，可以使用[多重施法](多重法术.md)同时施放多个分裂弹，可以像一把霰弹枪那样快速消灭敌人。
  * 大型版本由于拥有更高的射程和伤害，单独使用也有很好的效果，不过其法力消耗也 _显著_ 增加。
  * 分裂弹适合在高速杖中被[触发](触发.md)施放：高法力-伤害比对法杖的要求较低；而触发可以弥补短射程的缺陷。试着组合带触发的投射物，足够数量的[多重释放](法术.md)（用来同时发射多个分裂弹）以及找到的任何修正法术，你也许会惊讶于这个不起眼的法术。
  * 分裂弹的定时变种由于其散射与短射程相对更不实用。通常[火花弹](火花弹.md)或[魔法箭](魔法箭.md)是提供触发或定时的更好选择。 
    * 一个例外是定时分裂弹+[连锁魔弹](连锁魔弹.md)的经典组合：短射程的分裂弹恰好使得连锁魔弹能够在中等距离处被施放，击中远距离的敌人。而连锁魔弹较长的施法延迟会被[定时](触发.md)的特性完全消除。是火力强大且带有追踪的优秀组合。



## 画廊

[![](https://noita.wiki.gg/zh/images/Demo_spitter.gif?ffe173)](/zh/wiki/File:Demo_spitter.gif)

[](https://noita.wiki.gg/zh/wiki/File%3ADemo%20spitter.gif)

分裂弹攻击敌人

[![](https://noita.wiki.gg/zh/images/Demo_spitter_green.gif?79ca40)](/zh/wiki/File:Demo_spitter_green.gif)

[](https://noita.wiki.gg/zh/wiki/File%3ADemo%20spitter%20green.gif)

大型分裂弹攻击敌人

[![](https://noita.wiki.gg/zh/images/Demo_spitter_purple.gif?5e82f8)](/zh/wiki/File:Demo_spitter_purple.gif)

[](https://noita.wiki.gg/zh/wiki/File%3ADemo%20spitter%20purple.gif)

巨型分裂弹攻击敌人

[![](https://noita.wiki.gg/images/Spelldemo_spitter_bolt.gif?9731f5)](/zh/wiki/File:Spelldemo_spitter_bolt.gif)

[](https://noita.wiki.gg/zh/wiki/File%3ASpelldemo%20spitter%20bolt.gif)

分裂弹攻击[神圣之山](神圣之山.md)的测试雕像

[![](https://noita.wiki.gg/images/Spelldemo_large_spitter_bolt.gif?e82260)](/zh/wiki/File:Spelldemo_large_spitter_bolt.gif)

[](https://noita.wiki.gg/zh/wiki/File%3ASpelldemo%20large%20spitter%20bolt.gif)

大型分裂弹攻击[神圣之山](神圣之山.md)的测试雕像

[![](https://noita.wiki.gg/images/Spelldemo_giant_spitter_bolt.gif?fed3ed)](/zh/wiki/File:Spelldemo_giant_spitter_bolt.gif)

[](https://noita.wiki.gg/zh/wiki/File%3ASpelldemo%20giant%20spitter%20bolt.gif)

巨型分裂弹攻击[神圣之山](神圣之山.md)的测试雕像

## 历史

  * **[2019年11月05日(Early Access)](版本日志.md)**: 
    * 大型分裂弹的的伤害从11.25上调至12.5。
    * 巨型分裂弹的的伤害从13.75上调至15。
