...
**分类:** [Category:Stubs](Category%3AStubs.md) · [Category:具有负数的施放延迟法术](Category%3A具有负数的施放延迟法术.md) · [[Category:没有标签的法术]] · [Category:Spells](Category%3ASpells.md) · [Category:投射修正法术](Category%3A投射修正法术.md)
**来源:** https://noita.wiki.gg/zh/wiki/%E5%8F%8D%E8%BF%BD%E8%B8%AA
---
...
_本页面的内容不完善或仍需整理。来帮助我们[完善它](https://noita.wiki.gg/zh/wiki/%E5%8F%8D%E8%BF%BD%E8%B8%AA?action=edit)吧！_
...
目标导向法术   
---  
[](追踪.md) [](##) [](魔杖追踪.md) [](短距离追踪.md) [](转向敌人.md) [](回旋镖.md) [](自动瞄准.md) [](加速追踪.md) [](瞄准弧度.md) [](投射物区域传送.md)  
更改投射物方向以接近目标的修正法术。   
  
  
**反追踪** 是一个可以使投射物避开远离敌人的投射物修正。 

## 使用技巧

  * 魅惑的敌人（比如[召唤蛋](召唤蛋.md)产生的敌人）也可以产生排斥效果。
  * 配合[传送魔弹](传送魔弹.md)可以避免直接传到敌人脸上。
  * 配合[治疗魔弹](治疗魔弹.md)和圣山雕像或其他敌人可以治疗自己。
  * 可以加速[黑洞](黑洞.md)发掘。
  * 与一大堆[逐渐减速](逐渐减速.md)叠加会将其反转为[追踪](追踪.md)，如下所示：
    ...
    |spread=0
    |spellsCast=1
    |spells=BURST_3,DISC_BULLET_BIGGER,DIVIDE_4,DIVIDE_10,ADD_TRIGGER,DECELERATING_SHOT,ANTI_HOMING
    |alwaysCasts=
    }}
...
[法杖模拟器](https://tinker-with-wands-online.vercel.app/?a=1&c=2500&r=20&d=10&v=1&x=0&m=5000&l=7&q=0&s=BURST_3%2CDISC_BULLET_BIGGER%2CDIVIDE_4%2CDIVIDE_10%2CADD_TRIGGER%2CDECELERATING_SHOT%2CANTI_HOMING)
...
[![](https://noita.wiki.gg/images/Demo_anti_homing.gif?b7aea8)](/zh/wiki/File:Demo_anti_homing.gif)

[](https://noita.wiki.gg/zh/wiki/File%3ADemo%20anti%20homing.gif)

演示

[![](https://noita.wiki.gg/images/Demo_anti_homing_heal.gif?62b636)](/zh/wiki/File:Demo_anti_homing_heal.gif)

[](https://noita.wiki.gg/zh/wiki/File%3ADemo%20anti%20homing%20heal.gif)
