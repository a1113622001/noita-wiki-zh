...
**分类:** [Category:适用于最新版的页面](Category%3A适用于最新版的页面.md) · [Category:Secrets](Category%3ASecrets.md) · [Category:有使用次数的法术](Category%3A有使用次数的法术.md) · [Category:具有正数的施放延迟法术](Category%3A具有正数的施放延迟法术.md) · [[Category:没有标签的法术]] · [Category:Spells](Category%3ASpells.md) · [Category:其他法术](Category%3A其他法术.md)
**来源:** https://noita.wiki.gg/zh/wiki/%E5%8F%AC%E5%94%A4%E4%BC%A0%E9%80%81%E9%97%A8
---
...
**召唤传送门** 是一种特殊的其他类法术，在特定地点使用能召唤一个稳定的传送门，否则生成的传送门会迅速消散。 

## 使用技巧

  * 作为一个其他类法术，它不会在魔杖中生成，且其生成权重为 0 ，因此不可能在任何商店中出售。不过，你依然可能从[眼睛房间](沙漏房间.md)或[宝箱](宝箱.md)等无视权重生成法术的地方获得它。
  * 通常通过在[席西基地](席西基地.md)右下角的铁砧修复[损坏的法术](损坏的法术.md)来获得它。
  * 它的次数有限，但可以通过[无限法术](无限法术.md)无限化。


  * 它会阻断同一个施法块中位于其后的投射物的生成[[1]](#cite_note-1)。 
        ...
        |spread=0
        |spellsCast=1
        |spells=BURST_2,LIGHT_BULLET_TRIGGER,BURST_3,LIGHT_BULLET,SUMMON_PORTAL,NUKE_GIGA,SPITTER
        |alwaysCasts=
        }}
...
[法杖模拟器](https://tinker-with-wands-online.vercel.app/?a=1&c=2500&r=20&d=10&v=1&x=0&m=5000&l=7&q=0&s=BURST_2%2CLIGHT_BULLET_TRIGGER%2CBURST_3%2CLIGHT_BULLET%2CSUMMON_PORTAL%2CNUKE_GIGA%2CSPITTER)
...
[](分裂弹.md)
    ...
    * 位于同一个施法块中、召唤传送门之前的[火花弹](火花弹.md)能正常生成，不位于同一个施法块的[分裂弹](分裂弹.md)也能正常生成。
    * 位于同一个施法块中、召唤传送门之后的[巨型核弹](巨型核弹.md)却不能生成，但巨型核弹对施法块的速度修正和对充能的影响等会被正常应用。


  * 它会产生大量装饰性粒子，如果你想高频使用它，推荐把**设置-图形-装饰粒子数量** 拉到最低以降低性能消耗。
...
在地下丛林有四座[僧侣](Munkki.md)雕像，每一座雕像都水平或竖直地手持一根长棍。它们分布在地下丛林的东、西、南、北四个方向。 

雕像手中的长棍即是推断传送门正确位置的线索。北边和南边的雕像竖直持棍，东边和西边的雕像水平持棍，召唤传送门的正确位置就在雕像竖直和水平连线的交点处。 

[![](https://noita.wiki.gg/zh/images/thumb/Summonportalintersection.png/400px-Summonportalintersection.png?50ec14)](/zh/wiki/File:Summonportalintersection.png)

[](https://noita.wiki.gg/zh/wiki/File%3ASummonportalintersection.png)

以雕像手中棍子的方向画两条直线，相交处即是传送门稳定存在的位置。

这个传送门会将玩家传送到科技之蛋中。 

更多细节参见[万物之终结支线](万物之终结支线.md)。 

## 注释

  1. [↑](#cite_ref-1) 这是因为这个法术缺乏投射物组件`ProjectileComponent`，会导致投射物实载因报错而终止。
...
---  
| [](法术复制.md)[](音符法术.md)[](音符法术.md)[](音符法术.md)[](音符法术.md)[](音符法术.md)[](音符法术.md)[](音符法术.md)[](音符法术.md)[](音符法术.md)[](音符法术.md)[](音符法术.md)[](音符法术.md)[](音符法术.md)[](随机法术.md)[](复制随机法术.md)[](复制随机法术.md)[](复制三个随机法术.md)[](万物之终结.md)[](##)[](追加触发.md)[](追加触发.md)[](追加触发.md)[](初始.md)[](伽马.md)[](陶.md)[](终结.md)[](谬.md)[](斐.md)[](西格玛.md)[](泽塔.md)[](一分为多.md)[](一分为多.md)[](一分为多.md)[](一分为多.md)[](https://noita.wiki.gg/zh/wiki/%E6%9D%A1%E4%BB%B6%E8%A6%81%E6%B1%82%5C(%E6%B3%95%E6%9C%AF%5C)## "条件要求\(法术\)")[](https://noita.wiki.gg/zh/wiki/%E6%9D%A1%E4%BB%B6%E8%A6%81%E6%B1%82%5C(%E6%B3%95%E6%9C%AF%5C)## "条件要求\(法术\)")[](https://noita.wiki.gg/zh/wiki/%E6%9D%A1%E4%BB%B6%E8%A6%81%E6%B1%82%5C(%E6%B3%95%E6%9C%AF%5C)## "条件要求\(法术\)")[](https://noita.wiki.gg/zh/wiki/%E6%9D%A1%E4%BB%B6%E8%A6%81%E6%B1%82%5C(%E6%B3%95%E6%9C%AF%5C)## "条件要求\(法术\)")[](https://noita.wiki.gg/zh/wiki/%E6%9D%A1%E4%BB%B6%E8%A6%81%E6%B1%82%5C(%E6%B3%95%E6%9C%AF%5C)## "条件要求\(法术\)")[](https://noita.wiki.gg/zh/wiki/%E6%9D%A1%E4%BB%B6%E8%A6%81%E6%B1%82%5C(%E6%B3%95%E6%9C%AF%5C)## "条件要求\(法术\)")[](遁入虚空.md)  
---
