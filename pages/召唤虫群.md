...
**分类:** [[Category:Spells_with_different_related_projectile_counts]] · [Category:适用于最新版的页面](Category%3A适用于最新版的页面.md) · [Category:具有正数的施放延迟法术](Category%3A具有正数的施放延迟法术.md) · [Category:影响充能时间的法术](Category%3A影响充能时间的法术.md) · [Category:具有正数的充能延迟法术](Category%3A具有正数的充能延迟法术.md) · [Category:影响存在时间的修正](Category%3A影响存在时间的修正.md) · [Category:影响散射角度的修正](Category%3A影响散射角度的修正.md) · [Category:近战伤害法术](Category%3A近战伤害法术.md) · [Category:弹跳法术](弹跳法术.md) · [Category:火焰伤害法术](Category%3A火焰伤害法术.md) · [[Category:有多个法术的法术页面]] · [[Category:没有标签的法术]] · [Category:Spells](Category%3ASpells.md) · [Category:静态投射物法术](Category%3A静态投射物法术.md) · [Category:多投射物法术](Category%3A多投射物法术.md)
**来源:** https://noita.wiki.gg/zh/wiki/%E5%8F%AC%E5%94%A4%E8%99%AB%E7%BE%A4
---
...
4 (![Spell trigger.png](https://noita.wiki.gg/zh/images/Spell_trigger.png?e02122)5)
...
### ![Inventory Icon damage fire.png](https://noita.wiki.gg/zh/images/Inventory_Icon_damage_fire.png?1d7de9)火焰伤害
...
3 (![Spell trigger.png](https://noita.wiki.gg/zh/images/Spell_trigger.png?e02122)4)
...
5 (![Spell trigger.png](https://noita.wiki.gg/zh/images/Spell_trigger.png?e02122)6)
...
**召唤苍蝇群、召唤萤火虫群、召唤黄蜂群** 是一类静态投射物法术，能召唤不同种类虫群为你作战。 

被召唤的飞虫比正常的敌人版本小得多，会盘旋在你周围，它们接触敌人时会造成伤害。 

## 使用技巧

  * 召唤苍蝇群和召唤黄蜂群造成[![近战伤害](https://noita.wiki.gg/zh/images/Damage_Melee_dmg-large.png?c51ed6)](/zh/wiki/%E4%BC%A4%E5%AE%B3%E7%B1%BB%E5%9E%8B#近战伤害 "近战伤害") [近战](伤害类型.md)伤害，可以配合[冰冻放射](冰冻放射.md)修正秒杀敌人，不过这样会产生大量的[雪](雪.md)。而召唤萤火虫群则造成[![火焰伤害](https://noita.wiki.gg/zh/images/Damage_Fire_dmg-large.png?9d687a)](/zh/wiki/%E4%BC%A4%E5%AE%B3%E7%B1%BB%E5%9E%8B#火焰伤害 "火焰伤害") [火焰](伤害类型.md)伤害，会点燃它们接触到的易燃物和使敌人[![着火](https://noita.wiki.gg/images/thumb/Effect_on_fire.png/16px-Effect_on_fire.png?a829d4)](/zh/wiki/%E7%8A%B6%E6%80%81#着火 "着火") **[着火](状态.md)** ，但不会点燃玩家。
  * 所有的虫群都是[穿刺](穿刺与穿透.md)投射物，它们在碰撞敌人和地形时都不会失效，并且可以多次对敌人造成伤害，不过，它们有 20 帧（约 0.33 秒）的伤害间隔，因此每只虫子每秒最多造成 3 次伤害。


  * 它们自带追踪施法者的效果，所以平时它们会盘旋在你周围。要比较好地利用它们造成伤害的话可以搭配[追踪](追踪.md)修正，也可以利用一些特性把这种追踪施法者的效果改为在超大范围内追踪敌人。 
        ...
        |spread=0
        |spellsCast=1
        |spells=SUMMON_HOLLOW_EGG,CLIPPING_SHOT,FREEZE,SWARM_FLY
        |alwaysCasts=
        }}
...
[法杖模拟器](https://tinker-with-wands-online.vercel.app/?a=1&c=2500&r=20&d=10&v=1&x=0&m=5000&l=4&q=0&s=SUMMON_HOLLOW_EGG%2CCLIPPING_SHOT%2CFREEZE%2CSWARM_FLY)
...
[](##)
    ...
    * 利用[回旋蛋特性](召唤空的蛋.md)让虫群在超大范围内追踪敌人。
    * 配合[穿凿魔弹](穿凿魔弹.md)可以防止它们被地形卡住。
    ...
    |spread=0
    |spellsCast=1
    |spells=BURST_2,CLIPPING_SHOT,FREEZE,SWARM_FLY,DIVIDE_2,CESSATION
    |alwaysCasts=
    }}
...
[法杖模拟器](https://tinker-with-wands-online.vercel.app/?a=1&c=2500&r=20&d=10&v=1&x=0&m=5000&l=6&q=0&s=BURST_2%2CCLIPPING_SHOT%2CFREEZE%2CSWARM_FLY%2CDIVIDE_2%2CCESSATION)
...
[](遁入虚空.md)
    ...
    * 通过重启或与[遁入虚空](遁入虚空.md)一同使用，让虫群在超大范围内追踪敌人。
    * [一分为二](一分为多.md)用于规避遁入虚空增加的巨量充能和延迟。


  * 虫群有血量，可以被投射物击中。这意味着它们既可以为玩家挡住敌人的子弹，也可以被玩家的投射物击中而妨碍玩家攻击。
  * 萤火虫接触到[水](水.md)会受到高额的材料伤害。其他虫群接触到火源则会被点燃。
  * 使用这个法术时务必小心[![变形](https://noita.wiki.gg/images/thumb/Effect_polymorph.png/16px-Effect_polymorph.png?fcdbea)](/zh/wiki/%E7%8A%B6%E6%80%81#变形 "变形") **[变形](状态.md)** ，因为它们平时会盘旋在玩家附近，在你被变形之后它们很容易杀死你。
  * 如果配合[拉帕](拉帕.md)类法术，虫群会持续产生自身的复制品，从而在短时间内产生大量的虫子。 
    * 复制品不会受到修正影响，因此带有修正的虫群的本体会在拉帕法术的影响下很快消失，留下大量存在时间正常但没有修正效果的复制品虫群。
  * 配合[伤害领域](伤害领域.md)可以有效的造成伤害。



## 你知道吗

  * 它们召唤的飞虫的数量实际上比它们的描述少一只。不过，它们的[相关投射物](相关投射物.md)召唤的虫子的数量是正确的，这意味着用[追加触发](追加触发.md)或[阵型复制](阵型复制.md)调用它们的相关投射物能多生成一只飞虫。
  * 萤火虫群会受到[冰冷液体](冰冷液体.md)、[冰冷蒸汽](冰冷蒸汽.md)、[水](水.md)、[冰水](冰水.md)、[紫色毒液](紫色毒液.md)和[酸液](酸液.md)的材料伤害，而其他虫群只会受到酸液的材料伤害。
  * 每只苍蝇可以承受
...
的伤害。
  * 相较于相似的法术[召唤友好苍蝇](召唤友好苍蝇.md)，它们的血量更少，持续时间更短，但它们的伤害间隔（ 20 帧）比召唤友好苍蝇的苍蝇（ 30 帧）更短。
...
## 历史
  ...
  * **[2024年04月08日(Epilogue2)](版本日志.md)**: 
    * 所有虫群召唤的飞虫的数量减少 1 且法力消耗减少 10 。
    * 召唤苍蝇群： 
      * 从 6 级法术池中移除。
      * 2 级生成权重从 0.2 提升到 0.3 , 4 级从 0.2 提升到 0.4 。
    * 召唤萤火虫群： 
      * 从 4 级法术池中移除。
      * 5 级生成权重从 0.5 降低到 0.4 。
    * 召唤黄蜂群： 
      * 从 2 级法术池中移除。
      * 6 级生成权重从 0.5 提升到 0.6 。
