...
**召唤飞弹** 会发射一枚会缓慢追踪敌人的飞弹。 

## 使用技巧

  * 可以在低的初始速度下追踪并命中敌人。与[召唤触手](召唤触手.md)和沉重一击配合良好。
  * [拉帕](拉帕.md)系列召唤的复制并不会追踪敌人。



## 你知道吗？

  * [机械螃蟹](Heinäsirkka.md)的攻击是发射数枚类似该法术的小型飞弹。
  * 之前版本中的导弹法术没有声明`related_projetiles`, [追加触发](追加触发.md)对导弹不能正常工作 现已修复(update_20240214)



## 相册

[![Spelldemo summon missile.gif](https://noita.wiki.gg/images/Spelldemo_summon_missile.gif?534112)](/zh/wiki/File:Spelldemo_summon_missile.gif)

[](https://noita.wiki.gg/zh/wiki/File%3ASpelldemo%20summon%20missile.gif)
