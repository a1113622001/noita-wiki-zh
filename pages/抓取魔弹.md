...
**分类:** [Category:适用于最新版的页面](Category%3A适用于最新版的页面.md) · [Category:影响存在时间的修正](Category%3A影响存在时间的修正.md) · [Category:影响散射角度的修正](Category%3A影响散射角度的修正.md) · [[Category:没有标签的法术]] · [Category:Spells](Category%3ASpells.md) · [Category:投射物法术](Category%3A投射物法术.md)
**来源:** https://noita.wiki.gg/zh/wiki/%E6%8A%93%E5%8F%96%E9%AD%94%E5%BC%B9
---
...
传送法术   
---  
[](传送魔弹.md) [](传送魔弹.md) [](返回.md) [](交换者.md) [](##)  
涉及位移的法术，能够影响施法者，目标或两者。   
  
**抓取魔弹** （官中译为**“归家”传送魔弹** ）是一种投射物法术，能发射一种紫色魔弹，将命中的生物传送到抓取魔弹的生成位置。 

## 使用技巧

  * 可以用[远距离施放](远距离施放.md)施放这个法术，既避免了目标过于靠近自己产生的危险，又使得抓取位置更加准确。
  * 可以先冻住敌人，把它们传送过来后将它们轻松踢碎。
  * 可以用来把[席西医疗兵](席西治疗兵.md)和[穿心法师](穿心法师.md)传送到一些安全的位置。


  * 与[传送魔弹](传送魔弹.md)不同，它不会检查目的地是否有足够的空间容纳玩家、是否处在未加载区块，这常被用于[跃迁魔杖](专家攻略：跃迁配置%2F超传配置.md)和[传送点配置](专家攻略：传送点.md)中。 
        ...
        |spread=0
        |spellsCast=1
        |spells=ADD_DEATH_TRIGGER,BOMB_DETONATOR,TAU,DIVIDE_3,LIFETIME_DOWN,DIVIDE_10,PINGPONG_PATH,ADD_DEATH_TRIGGER,TENTACLE,ADD_TIMER,MIST_SLIME,CASTER_CAST,LIFETIME,HOMING_ACCELERATING,ORBIT_LARPA,PIERCING_SHOT,TELEPORT_PROJECTILE_CLOSER,DIVIDE_2,RESET
        |alwaysCasts=
        }}
...
[](魔杖刷新.md)
    ...
    * 一个实用的传送点配置，改进自 UISSD 的配置。第一次使用留下一个传送点，之后每次使用会回到上一次使用时的位置，并且允许连带周围的敌人一起传送。


  * 由于它在前 6 帧（ 0.1 秒）内不能命中施法者，所以它与[内在施法](内在施法.md)的组合需要搭配特定组合进行减速或通过其他手段才能抓取施法者。



## 你知道吗

  * 抓取魔弹可以抓取[手石像](机械僧侣.md)，这可以使[献祭手石像](雪山祭坛.md)的完成变得简单。


  * 抓取魔弹抓取生物时，传送的目的地由这个生物周围半径 32 像素内 ID 最小（生成最早）的抓取魔弹决定。 
        ...
        |spread=0
        |spellsCast=1
        |spells=DIVIDE_2,LIFETIME_DOWN,TRUE_ORBIT,HEAVY_SHOT,TELEPORT_PROJECTILE_CLOSER,KANTELE_A
        |alwaysCasts=
        }}
...
[法杖模拟器](https://tinker-with-wands-online.vercel.app/?a=1&c=2500&r=20&d=10&v=1&x=0&m=5000&l=6&q=0&s=DIVIDE_2%2CLIFETIME_DOWN%2CTRUE_ORBIT%2CHEAVY_SHOT%2CTELEPORT_PROJECTILE_CLOSER%2CKANTELE_A)
...
[](传送魔弹.md)
    ...
    * 第一根魔杖有1/15的概率产生一个环绕玩家的[永久化](专家攻略：无限持续时间法术.md)抓取魔弹，在特定地点使用直到产生永久化抓取魔弹。之后在任意地点使用第二根魔杖就能传送到先前的特定地点。



## 画廊

[![](https://noita.wiki.gg/images/thumb/Freeze_Charge_%2B_Homebringer_%2B_Contact_Damage.gif/320px-Freeze_Charge_%2B_Homebringer_%2B_Contact_Damage.gif?863abe)](/zh/wiki/File:Freeze_Charge_%2B_Homebringer_%2B_Contact_Damage.gif)

[](https://noita.wiki.gg/zh/wiki/File%3AFreeze%20Charge%20%2B%20Homebringer%20%2B%20Contact%20Damage.gif)

[冰冻](冰冻.md) \+ 抓取 + [伤害领域](https://noita.wiki.gg/zh/wiki/%E4%BC%A4%E5%AE%B3%E9%A2%86%E5%9F%9F%5C(%E5%A4%A9%E8%B5%8B%5C) "伤害领域\(天赋\)")天赋是一个不错的组合

## 历史

  * **[2024年04月08日(Epilogue2)](版本日志.md)**: 将 0 级法术的生成权重从 0.6 改为 0.4，4 级法术的生成权重从 0.4 改为 0.7。
