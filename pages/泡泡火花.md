...
**分类:** [Category:具有负数的施放延迟法术](Category%3A具有负数的施放延迟法术.md) · [Category:影响存在时间的修正](Category%3A影响存在时间的修正.md) · [Category:影响散射角度的修正](Category%3A影响散射角度的修正.md) · [Category:投射物伤害法术](Category%3A投射物伤害法术.md) · [Category:弹跳法术](弹跳法术.md) · [[Category:有多个法术的法术页面]] · [[Category:没有标签的法术]] · [Category:Spells](Category%3ASpells.md) · [Category:投射物法术](Category%3A投射物法术.md)
**来源:** https://noita.wiki.gg/zh/wiki/%E6%B3%A1%E6%B3%A1%E7%81%AB%E8%8A%B1
---
...
一种具有弹性但精确度不高的法术，在击中敌人时或2秒的持续时间结束时造成小范围爆炸。 

泡泡火花具有一个触发变种。 

## 使用技巧

  * 该法术与[追踪](追踪.md)、[伤害领域](伤害领域.md)等类型的修正法术，或类似[火焰弧](火焰弧.md)的轨迹修正法术组合使用，可能会产生奇效（还可以配合**多重释放** 类法术）。
  * 非触发版本的泡泡火花具有1:1的法力消耗与伤害之比，使其成为一个高效的无次数限制法术。
  * 泡泡火花具有从墙壁上反弹的特性。
  * 泡泡火花可以破坏普通[岩石](岩石.md)。 
    * 使用魔杖抵住墙壁射击，会导致泡泡火花卡在墙壁中，从而破坏墙壁。利用这种特性可以在特殊情况下用于缓慢挖掘。
    * 液体可以使泡泡火花减速，使得挖掘墙壁更容易。



## 画廊

[![](https://noita.wiki.gg/zh/images/Demo_bubbleshot.gif?7ed21a)](/zh/wiki/File:Demo_bubbleshot.gif)
