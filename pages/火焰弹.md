...
**分类:** [Category:有使用次数的法术](Category%3A有使用次数的法术.md) · [Category:具有正数的施放延迟法术](Category%3A具有正数的施放延迟法术.md) · [Category:影响存在时间的修正](Category%3A影响存在时间的修正.md) · [Category:影响散射角度的修正](Category%3A影响散射角度的修正.md) · [[Category:影响后坐力的修正]] · [Category:投射物伤害法术](Category%3A投射物伤害法术.md) · [Category:火焰伤害法术](Category%3A火焰伤害法术.md) · [Category:爆炸伤害法术](Category%3A爆炸伤害法术.md) · [Category:弹跳法术](弹跳法术.md) · [[Category:有多个法术的法术页面]] · [[Category:没有标签的法术]] · [Category:Spells](Category%3ASpells.md) · [Category:投射物法术](Category%3A投射物法术.md)
**来源:** https://noita.wiki.gg/zh/wiki/%E7%81%AB%E7%84%B0%E5%BC%B9
---
...
一个能够发射爆炸性火球的[法术](法术.md)，且具有一定反弹能力，当火球正面击中敌人或地形时会引爆。比起需要延时引爆的[炸弹](炸弹.md)，火焰弹反而更接近Noita中的手榴弹。 

在新游戏模式下，火焰弹的基础版本是初始[法杖](法杖.md)可能携带的法术之一。 

火焰弹共有5种变体，所有变体均受使用次数限制。 

## 使用技巧

  * 普通的火焰弹在早期关卡中常见且实用，既可以作为挖掘工具，也可以对敌群造成小范围伤害。美中不足的是，由于反弹的特性，发射时需要稍加控制。
  * 带有触发的火焰弹通常出现在带有许多普通火焰弹的法杖上，使法杖变成一个可以四处弹跳并爆炸多次的散射火焰弹法杖。由于其有限的使用次数和高法力消耗，它在此之外的用处较为有限。
  * 大型火焰弹和巨型火焰弹尽管使用次数有限，但由于它们大范围的爆炸伤害和地形破坏能力，在各个游戏阶段中都很有用。同[大型魔法飞弹](魔法飞弹.md)和[巨型魔法飞弹](魔法飞弹.md)一样，它们也非常适合乱序魔杖。
  * 只要你的攻击角度正确，火焰弹也是能挖天花板的。
  * 相当大的施法延迟并没有太大的危害，反而可以帮助您避免一次发射过多而浪费充能。
  * 同[巨型魔法飞弹](魔法飞弹.md)一样，对于这么一个威力巨大但却有次数限制的法术，[无限法术](无限法术.md)就是解除限制的最强的天赋，能够实现真正意义上的地毯式轰炸。同大部分爆炸类的法术一样，使用前还请保证自己拥有回避爆炸伤害的手段！



### 关于怪异火焰弹

  * 怪异火焰弹的行进轨迹与[蛇行](蛇行.md)相似，不过只在水平方向呈现正弦波形轨迹，而在垂直方向上只会在施法者当前水平高度的一定幅度内上下摆动。 
    * 这是因为怪异火焰弹轨迹的实现方式是：每隔 2 帧检查，当施法者的位置低于它时，将重力设为 600（向下）；高于它时，将重力设为 -600（向上）。而水平方向的速度不受影响，这使得它看起来像在围绕施法者的水平位置上下摆动。



## 画廊

[![](https://noita.wiki.gg/zh/images/Giant_Firebolt%28demo%29.gif?e53c4b)](/zh/wiki/File:Giant_Firebolt\(demo\).gif)

[](https://noita.wiki.gg/zh/wiki/File%3AGiant%20Firebolt%5C(demo%5C).gif "放大")
