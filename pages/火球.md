...
一种相当强大的爆炸性投射物，具有15次使用次数。火球的飞行速度较慢，受重力影响较小，在短时间后爆炸。它也会点燃路径上小范围内的可燃物和气体。官方mod中的火焰法师职业以该法术作为初始的攻击法术。 

[火魔](Stendari.md)所使用的攻击是该法术的弱化版本。 

## 使用技巧

  * 15次充能的限制让这个法术不那么有吸引力，尤其是在稍后期的地图中，其较小的爆炸范围也并不适用于挖掘。
  * 在没有更好的法术组合时，在乱序杖中配置多个该法术也能达到不错的输出能力。
  * 因为火球能点燃附近的气体，它可以用来清除狭小通道里的[冰冷蒸汽](冰冷蒸汽.md)和[绿色毒液蒸汽](绿色毒液蒸汽.md)这样的危险气体。



## 画廊

[![](https://noita.wiki.gg/zh/images/Fireball-demo.gif?858565)](/zh/wiki/File:Fireball-demo.gif)

法术效果展示

[![](https://noita.wiki.gg/zh/images/Demo_fireball_combust_1.gif?ad2722)](/zh/wiki/File:Demo_fireball_combust_1.gif)

火球点燃附近的木材

[![](https://noita.wiki.gg/zh/images/Demo_fireball_combust_2.gif?94da87)](/zh/wiki/File:Demo_fireball_combust_2.gif)
