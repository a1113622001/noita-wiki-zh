...
**分类:** [Category:适用于最新版的页面](Category%3A适用于最新版的页面.md) · [Category:具有正数的施放延迟法术](Category%3A具有正数的施放延迟法术.md) · [Category:影响存在时间的修正](Category%3A影响存在时间的修正.md) · [Category:影响散射角度的修正](Category%3A影响散射角度的修正.md) · [Category:拥有暴击概率加成的法术](Category%3A拥有暴击概率加成的法术.md) · [Category:投射物伤害法术](Category%3A投射物伤害法术.md) · [Category:爆炸伤害法术](Category%3A爆炸伤害法术.md) · [Category:定时法术](Category%3A定时法术.md) · [[Category:有多个法术的法术页面]] · [[Category:没有标签的法术]] · [Category:Spells](Category%3ASpells.md) · [Category:投射物法术](Category%3A投射物法术.md)
**来源:** https://noita.wiki.gg/zh/wiki/%E7%81%AB%E8%8A%B1%E5%BC%B9
---
...
**火花弹** 是一种投射物法术，能发射一枚快速飞行的粉紫色子弹。作为游戏开局时可能自带的投射物之一，它单薄但可靠。 

它也具有[触发](触发.md)、双重触发和[定时](定时.md)三个变种。 

## 使用技巧

  * 在开局自带的投射物中，它的伤蓝比达到 3:5 ，仅次于[分裂弹](分裂弹.md)（ 8:5 ），与[弹跳绿豆](弹跳绿豆.md)相同（但弹跳绿豆通常来说会因为差速特性导致伤害降低）。


  * 高弹速使它容易命中敌人，而低法力消耗使它对法力负担较低，而增加暴击。同时释放多个火花弹并添加一些增加伤害的修正（如[伤害增强](伤害增强.md)）就可以造成很可观的伤害。 
...
[](##)
    ...
    * 同时释放了 4 个伤害增强修正的火花弹，单次射击能造成[![投射物伤害](https://noita.wiki.gg/zh/images/Damage_Projectile_dmg-large.png?306896)](/zh/wiki/%E4%BC%A4%E5%AE%B3%E7%B1%BB%E5%9E%8B#投射物伤害 "投射物伤害")52的伤害，并且有 20% 的概率暴击造成 5 倍伤害。


  * 触发火花弹和双重触发火花弹弹速较快，容易命中敌人，因此它们很适合把其他法术（如[链锯](链锯.md)等）送到敌人身上。
  * 仅使用一个[缩减存在时间](缩减存在时间.md)就可以使此法术永久化，这可以方便地完成[神明对你印象深刻](Steam成就.md)这一成就。更多信息参见[专家攻略：无限持续时间法术](专家攻略：无限持续时间法术.md)。
  * 火花弹可以破坏较软的材料，你可以用它缓慢地挖掘[煤堆](煤.md)，这在前期可能会有帮助。更多信息参见[挖掘](挖掘.md)。
...
[![](https://noita.wiki.gg/zh/images/Demo_light_bullet.gif?637af8)](/zh/wiki/File:Demo_light_bullet.gif)

[](https://noita.wiki.gg/zh/wiki/File%3ADemo%20light%20bullet.gif)
...
## 历史
  ...
  * **[2024年04月08日(Epilogue2)](版本日志.md)**: 定时火花弹的 3 级法术生成权重从 0.5 提高到 0.75 。
  * **[2019年10月11日(Early Access)](版本日志.md)**: 
    * 将火花弹从 2 级法术池中移除。
    * 将触发火花弹和定时火花弹从 4 级法术池中移除。
