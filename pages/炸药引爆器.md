...
**分类:** [Category:适用于最新版的页面](Category%3A适用于最新版的页面.md) · [Category:影响存在时间的修正](Category%3A影响存在时间的修正.md) · [Category:影响散射角度的修正](Category%3A影响散射角度的修正.md) · [[Category:使用不推荐格式描述速度的信息框]] · [[Category:没有标签的法术]] · [Category:Spells](Category%3ASpells.md) · [Category:静态投射物法术](Category%3A静态投射物法术.md)
**来源:** https://noita.wiki.gg/zh/wiki/%E7%82%B8%E8%8D%AF%E5%BC%95%E7%88%86%E5%99%A8
---
...
**炸药引爆器** （又称**引爆器** ）是一种静态投射物法术，能在释放后的第 2 帧使世界上的绝大多数法术即刻失效，爆炸半径大于 2 像素的法术还会发生爆炸。 

## 使用技巧

  * 作为一个静态投射物法术，它不会自然生成在魔杖中（始终释放除外），如果你想要寻找它们，可以去[圣山](圣山.md)、[眼睛房间](沙漏房间.md)碰碰运气。
  * 它生效时可以令世界上几乎所有法术失效，极少数的例外包括[怪异传送门](怪异传送门.md)、[召唤传送门](召唤传送门.md)、[召唤平台](召唤平台.md)、[召唤墙壁](召唤墙壁.md)和[雾](雾.md)等[[1]](#cite_note-1)。此外，它不会使自己失效，但可以使另一个引爆器失效。 
    * 它的效果没有距离限制，只要那些**能被引爆器清除的法术** 还在被加载就能被清除。
    * 和那些**能被引爆器清除的法术** 一起施放会使它们仅存在 2 帧。
    * 与之不同的是，[置换术](黑洞置换术.md)系列法术可以使怪异传送门和召唤传送门失效。
  * 它生效时会令爆炸半径大于 2 像素的法术立刻爆炸，即使这种法术原本不会爆炸（如[光明穿凿](光明穿凿.md)、[召唤岩石](召唤岩石.md)等）[[2]](#cite_note-2)。这种爆炸不带有施法者信息，会造成自伤和[技巧击杀](技巧击杀.md)。更详细的机制参见[爆炸机制](爆炸机制.md)。 
    * 搭配[易爆](易爆的投射物.md)可以将绝大多数法术的爆炸半径提高到 2 像素以上，从而保证**能被引爆器清除的法术** 都能产生爆炸。
    * 用引爆器引爆[炸药箱](炸药箱.md)时会发生 2 次爆炸，而直接打爆炸药箱则会产生 3 次爆炸；引爆[丙烷罐](丙烷罐.md)法术产生的丙烷罐时会产生 1 次爆炸，而打爆它或等待它自然爆炸会产生 2 次爆炸。


  * 与[光剑](光剑.md)、[连锁魔弹](连锁魔弹.md)和[冰冷凝视](冰冷凝视.md)等法术搭配时能使它们失效并造成[![爆炸伤害](https://noita.wiki.gg/zh/images/Damage_Explosion_dmg-large.png?7e98eb)](/zh/wiki/%E4%BC%A4%E5%AE%B3%E7%B1%BB%E5%9E%8B#爆炸伤害 "爆炸伤害")125的爆炸，这种爆炸同样无施法者信息，如果没有[爆炸免疫](爆炸免疫.md)需要小心自伤。 
        ...
        |spread=0
        |spellsCast=1
        |spells=LIGHT_BULLET_TRIGGER,BURST_2,FREEZING_GAZE,BOMB_DETONATOR
        |alwaysCasts=
        }}
...
[法杖模拟器](https://tinker-with-wands-online.vercel.app/?a=1&c=2500&r=20&d=10&v=1&x=0&m=5000&l=4&q=0&s=LIGHT_BULLET_TRIGGER%2CBURST_2%2CFREEZING_GAZE%2CBOMB_DETONATOR)
...
[](##)
    ...
    * 和[冰冷凝视](冰冷凝视.md)搭配，击中敌人或地形时能造成[![爆炸伤害](https://noita.wiki.gg/zh/images/Damage_Explosion_dmg-large.png?7e98eb)](/zh/wiki/%E4%BC%A4%E5%AE%B3%E7%B1%BB%E5%9E%8B#爆炸伤害 "爆炸伤害")1500的伤害。


  * 如果在高速杖中做到每 2 帧施放一次。它能有效地使得几乎所有投射物都不可能击中你，只有近战、爆炸和材料类的伤害能对你造成威胁。 
    * 引爆器生效时会引爆还在空中的另一个引爆器，并且会对附近的玩家造成高额的[![爆炸伤害](https://noita.wiki.gg/zh/images/Damage_Explosion_dmg-large.png?7e98eb)](/zh/wiki/%E4%BC%A4%E5%AE%B3%E7%B1%BB%E5%9E%8B#爆炸伤害 "爆炸伤害") [爆炸](伤害类型.md)伤害，因此引爆器有 1 帧的生效间隔，每帧施放一次不仅不能提高防护效果，还有自伤的风险。
    * 将它整合进传送杖中可以使传送跑图相对更安全，并且它能使[传送魔弹](传送魔弹.md)只存在 2 帧。 
          ...
          |spread=0
          |spellsCast=1
          |spells=MANA_REDUCE,CHAINSAW,BURST_3,TELEPORT_PROJECTILE_SHORT,BOMB_DETONATOR
          |alwaysCasts=
          }}
...
[法杖模拟器](https://tinker-with-wands-online.vercel.app/?a=1&c=2500&r=20&d=10&v=1&x=0&m=5000&l=5&q=0&s=MANA_REDUCE%2CCHAINSAW%2CBURST_3%2CTELEPORT_PROJECTILE_SHORT%2CBOMB_DETONATOR)
...
[](##)
  ...
  * 能移除[BOSS](BOSS.md)的大部分投射物，也能够使[魔杖鉴赏家](魔杖鉴赏家.md)召唤的魔杖和[古代炼金术士](古代炼金术士.md)的护盾失效，因此该法术对于boss极其强力。
  * 天然的丙烷罐等自然生成的爆炸物不会被引爆，但法术[丙烷罐](丙烷罐.md)召唤出来的会被引爆。



## 画廊

[![](https://noita.wiki.gg/zh/images/%E5%8F%AC%E5%94%A4%E7%9F%B3%E5%A4%B4%E5%B9%B6%E4%BD%BF%E7%94%A8%E5%BC%95%E7%88%86%E5%99%A8%E5%BC%95%E7%88%86.gif?fb5f95)](/zh/wiki/File:%E5%8F%AC%E5%94%A4%E7%9F%B3%E5%A4%B4%E5%B9%B6%E4%BD%BF%E7%94%A8%E5%BC%95%E7%88%86%E5%99%A8%E5%BC%95%E7%88%86.gif)

[](https://noita.wiki.gg/zh/wiki/File%3A%E5%8F%AC%E5%94%A4%E7%9F%B3%E5%A4%B4%E5%B9%B6%E4%BD%BF%E7%94%A8%E5%BC%95%E7%88%86%E5%99%A8%E5%BC%95%E7%88%86.gif)

用引爆器引爆石头。注意这种爆炸带有自伤且能达成技巧击杀。

## 历史

  * **[2024年04月08日(Epilogue2)](版本日志.md)**: 
    * 将 2 、 4 和 5 级法术的生成权重从 1.0 分别更改为 0.5 、 0.45 和 0.5 。
    * 修复了“若空中有不可引爆的投射物则什么都不做”的bug。
  * **[2019年10月23日(Early Access)](版本日志.md)**: 将使用次数由 50 次改为无限。



## 注释

  1. [↑](#cite_ref-1) 因为引爆器使法术失效时要求投射物有投射物标签和投射物组件`[ProjectileComponent](Documentation%3A ProjectileComponent.md)`。怪异传送门和召唤传送门缺乏投射物组件，而召唤平台、召唤墙壁和雾缺乏投射物标签。
  2. [↑](#cite_ref-2) 这是因为引爆器强制启用了它们的两种爆炸开关`on_death_explode`和`on_lifetime_out_explode`。
