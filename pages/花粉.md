...
**分类:** [Category:具有正数的施放延迟法术](Category%3A具有正数的施放延迟法术.md) · [Category:影响存在时间的修正](Category%3A影响存在时间的修正.md) · [Category:影响散射角度的修正](Category%3A影响散射角度的修正.md) · [Category:投射物伤害法术](Category%3A投射物伤害法术.md) · [Category:爆炸伤害法术](Category%3A爆炸伤害法术.md) · [Category:弹跳法术](弹跳法术.md) · [[Category:没有标签的法术]] · [Category:Spells](Category%3ASpells.md) · [Category:投射物法术](Category%3A投射物法术.md)
**来源:** https://noita.wiki.gg/zh/wiki/%E8%8A%B1%E7%B2%89
---
...
**花粉** 将是一种特殊的投射物法术，该法术会发射一枚高初速度的花粉子弹，并在移动一小段距离后迅速减速至停止。 

接下来，这种子弹会开始缓慢地向追踪范围内的任何敌人飘去，并在接触时产生小爆炸。敌人的子弹或带有友方伤害的投射物（如[聚爆光束](聚爆光束.md)或[穿刺魔弹](穿刺魔弹.md)修正）可以与漂浮的花粉碰撞，因此射出一大片花粉可以兼作抵御敌人火力的盾牌,注意:挡不住[机械冷冻兵](Jäähdytyslaite.md)的投射物。漂浮的花粉会对玩家造成伤害。 

该法术似乎存在一个BUG，即该法术的射弹会可能在没有伤害碰撞箱的情况下生成，导致花粉会无害地卡在敌人身上直至存在时间结束。也可能是许多花粉重叠的区域会导致投射物无法命中怪物(例如火花弹会直接穿过去),请尝试攻击敌方没被花粉覆盖的部分或者等花粉存在时间结束的爆炸伤害炸死怪物 但[机械投枪手](Peitsivartija.md)免疫爆炸,也可以选择用[伤害领域](伤害领域.md)修饰花粉,使其重合时也能造成伤害. 

如果给花粉附加能够伤害玩家的法术修正，例如[嗜血](嗜血.md)和[穿刺魔弹](穿刺魔弹.md)，会产生负面的效果，导致发射的花粉能够相互碰撞并爆炸消失。 

## 使用技巧

  * 该法术在漂浮追踪时的移动速度非常慢，因此经常无法追上逃跑的敌人。这可以通过[加速](加速.md)和[追踪](追踪.md)修正来解决。
  * 该法术不稳定的碰撞箱意味着这是伤害性修正法术的优秀载体，例如[伤害领域](伤害领域.md)和[火球环绕](火球环绕.md)，可以提供比直接增加投射物伤害的修正更大的好处。尤其是[伤害领域](伤害领域.md)作用下的花粉，如果卡在敌人身上可以造成大量伤害。
  * [斥力场](斥力场.md)能够使花粉对玩家几乎无害。
  * 花粉在其发射至自然下落期间会被敌方尸体阻挡,但是在其经历过初速度消失的时间后,在追踪敌人的状态下可以穿过敌方尸体,击中被尸体掩埋的敌人.
  * 敌人用带有花粉的法杖发射的花粉依然会追踪敌人而且阻挡敌方子弹([机械冷冻兵](Jäähdytyslaite.md)的子弹依旧阻挡不了)且不会阻挡攻击到不己方的子弹,但[反制法师](Palauttajamestari.md)复制的花粉并不会追踪敌方并且追踪米娜(但其他怪物攻击反制法师后它会发射一个追踪攻击者的花粉)
...
因为花粉会与玩家的自伤穿刺法术（如聚爆光束）碰撞。根据这个机制可以创造出一种自触发循环：带有追加触发的穿刺投射物与花粉碰撞，触发产生另一个花粉后，投射物立刻与新产生的花粉碰撞并再次触发，如此循环。 
...
[聚爆光束](聚爆光束.md)用作触发最为合适，不过也可以用其他穿刺修正代替。 
...
[远距离施放](远距离施放.md)用于防止刚出现的投射物直接碰到花粉，导致在穿刺修正还没生效的第一帧因命中目标而消失。也可以防止第一枚花粉被穿刺魔弹修正。 

在此基础上，加入更多法术来创造独特的效果，如赶路杖: 
    ...
    |spread=0
    |spellsCast=1
    |spells=BURST_2,POLLEN,ADD_TRIGGER,GLOWING_BOLT,NOLLA,BURST_2,POLLEN,TELEPORT_PROJECTILE_STATIC
    |alwaysCasts=
    }}
...
[法杖模拟器](https://tinker-with-wands-online.vercel.app/?a=1&c=2500&r=20&d=10&v=1&x=0&m=5000&l=8&q=0&s=BURST_2%2CPOLLEN%2CADD_TRIGGER%2CGLOWING_BOLT%2CNOLLA%2CBURST_2%2CPOLLEN%2CTELEPORT_PROJECTILE_STATIC)
