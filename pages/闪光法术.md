...
**分类:** [Category:具有负数的施放延迟法术](Category%3A具有负数的施放延迟法术.md) · [Category:可解锁法术](Category%3A可解锁法术.md) · [[Category:有多个法术的法术页面]] · [[Category:没有标签的法术]] · [Category:Spells](Category%3ASpells.md) · [Category:投射修正法术](Category%3A投射修正法术.md)
**来源:** https://noita.wiki.gg/zh/wiki/%E9%97%AA%E5%85%89%E6%B3%95%E6%9C%AF
---
...
**闪光法术** 会让投射物染上颜色，并减少0.13秒的施放延迟。 

它们的主要作用是为了美化，而**隐形法术** 可以通过减少渲染过多的粒子效果来优化性能。 
...
将任意[翡翠石板](翡翠石板.md)丢进[湖泊](湖泊.md)中的炼金术士小屋即可解锁该系列法术。翡翠石板丢入后会出现通往正下方小房间的传送门，里面有该系列全部法术和一个[癫狂炼金术师](癫狂炼金术师.md)。首次进入时允许在其中编辑法杖。 
