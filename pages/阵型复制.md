...
**分类:** [Category:版本未知的页面](Category%3A版本未知的页面.md) · [Category:需要补充图片的页面](Category%3A需要补充图片的页面.md) · [Category:有使用次数的法术](Category%3A有使用次数的法术.md) · [[Category:有多个法术的法术页面]] · [[Category:没有标签的法术]] · [Category:Spells](Category%3ASpells.md) · [Category:实用法术](Category%3A实用法术.md)
**来源:** https://noita.wiki.gg/zh/wiki/%E9%98%B5%E5%9E%8B%E5%A4%8D%E5%88%B6
---
...
向两个方向射出投射物的复制品，形成三叉阵型，复制品依然消耗法力
...
**阵型复制** （俗称**紫复制** ，游戏中名称见[#阵型列表](#阵型列表)）可以复制该法术后的一个投射物法术若干次。复制的法力消耗为自身的法力消耗加上后一法术的法力消耗消耗若干次。 

## 效果

  * 检查后一个法术是否是投射物、静态投射物或材料，如果不是则跳过下一步。
  * 复制后一个法术 N-1 次，N 为它的复制数，比如**复制法术 - 五边形** 会复制 4 次。 
    * 每复制一次之前，都会先消耗等同于后一法术的法力值。
    * 如果在复制过程中，法杖法力不足，该法术会立刻终止复制。
  * 接下来为施法块添加一个[阵型](阵型.md)效果。
  * 最后进行一次抽取。
...
## 使用技巧
  ...
  * 先复制后抽取，因此在复制过程中，如果法力消耗不足以释放原始投射物，则原始投射物会被跳过且**不消耗次数** 。可以利用这种方法复制如[活力之环](活力之环.md)和[黑洞](黑洞.md)等有次数限制之类的法术。
  * 该法术具有较高的法力消耗，适合在爆发性输出的配置中应用。


  * 复制的投射物引用[相关投射物](相关投射物.md)。可以像[追加触发](追加触发.md)配合[蠕虫雨](蠕虫雨.md)那样生成[蠕虫](Jättimato.md)。
...
与[阵型](阵型.md)类似，复制法术也会设定阵型角度，但是设置角度时机有一定差异。 

复制法术在抽取前（复制后）就会设定阵型角度，这会使不同阵型混用时有不同的结算次序。而最后结算的阵型会覆盖前面的阵型角度。详见[专家攻略：抽取](专家攻略：抽取.md)。 
...
---|---|---|---|---  
图标  | 名称  | 游戏中名称   
[![Spell circle shape.png](https://noita.wiki.gg/zh/images/thumb/Spell_circle_shape.png/16px-Spell_circle_shape.png?36f216)](/zh/wiki/File:Spell_circle_shape.png) | [阵型 - 六边形](阵型.md) | 阵型 - 六边形  | 6 | 0  | 抽取后  | ± 180°  
[![Hexa shot.png](https://noita.wiki.gg/images/Hexa_shot.png?eb22f3)](/zh/wiki/File:Hexa_shot.png) | 复制法术 - 六边形  | 六角法术  | 1 | 5  | 抽取前   
[![Spell pentagram shape.png](https://noita.wiki.gg/zh/images/thumb/Spell_pentagram_shape.png/16px-Spell_pentagram_shape.png?2b24ad)](/zh/wiki/File:Spell_pentagram_shape.png) | [阵型 - 五边形](阵型.md) | 阵型 - 五边形  | 5 | 0  | 抽取后  | ± 180°  
[![Penta shot.png](https://noita.wiki.gg/images/Penta_shot.png?457669)](/zh/wiki/File:Penta_shot.png) | 复制法术 - 五边形  | 五角法术  | 1 | 4  | 抽取前   
[![Quad shot.png](https://noita.wiki.gg/images/Quad_shot.png?821e28)](/zh/wiki/File:Quad_shot.png) | 复制法术 - 十字  | 四重法术[[1]](#cite_note-1) | 1 | 3  | 抽取前  | ± 180°  
[![Spell i shape.png](https://noita.wiki.gg/zh/images/thumb/Spell_i_shape.png/16px-Spell_i_shape.png?1fb35c)](/zh/wiki/File:Spell_i_shape.png) | [阵型 - 前后](阵型.md) | 阵型 - 背后  | 2 | 0  | 抽取后  | ± 180°  
[![I shot.png](https://noita.wiki.gg/images/I_shot.png?74211f)](/zh/wiki/File:I_shot.png) | 复制法术 - 前后  | 复制法术  | 1 | 1  | 抽取前   
[![Spell t shape.png](https://noita.wiki.gg/zh/images/thumb/Spell_t_shape.png/16px-Spell_t_shape.png?27d490)](/zh/wiki/File:Spell_t_shape.png) | [阵型 - T](阵型.md) | 阵型 - 上下  | 3 | 0  | 抽取后  | ± 90°  
[![T shot.png](https://noita.wiki.gg/images/T_shot.png?19f31c)](/zh/wiki/File:T_shot.png) | 复制法术 - T  | 上下法术  | 1 | 2  | 抽取前   
[![Spell y shape.png](https://noita.wiki.gg/zh/images/thumb/Spell_y_shape.png/16px-Spell_y_shape.png?14f89a)](/zh/wiki/File:Spell_y_shape.png) | [阵型 - 分叉](阵型.md) | 阵型 - 分叉  | 2 | 0  | 抽取后  | ± 45°  
[![Y shot.png](https://noita.wiki.gg/images/Y_shot.png?36e6bf)](/zh/wiki/File:Y_shot.png) | 复制法术 - 分叉  | 分叉法术  | 1 | 1  | 抽取前   
[![Spell w shape.png](https://noita.wiki.gg/zh/images/thumb/Spell_w_shape.png/16px-Spell_w_shape.png?ae401c)](/zh/wiki/File:Spell_w_shape.png) | [阵型 - 三叉](阵型.md) | 阵型 - 三叉  | 3 | 0  | 抽取后  | ± 20°  
[![W shot.png](https://noita.wiki.gg/images/W_shot.png?9acfc2)](/zh/wiki/File:W_shot.png) | 复制法术 - 三叉  | 三岔法术  | 1 | 1  | 抽取前   
[![Spell freezing gaze.png](https://noita.wiki.gg/zh/images/thumb/Spell_freezing_gaze.png/16px-Spell_freezing_gaze.png?18247e)](/zh/wiki/File:Spell_freezing_gaze.png) | [冰冷凝视](冰冷凝视.md) | 冰冷凝视  | 0 | 12  | 施放时  | ± 30°  
[![Spell divide 10.png](https://noita.wiki.gg/zh/images/thumb/Spell_divide_10.png/16px-Spell_divide_10.png?200a1c)](/zh/wiki/File:Spell_divide_10.png) | [一分为多](一分为多.md) | 一分为多  | 0 | 2, 3, 4, 10  | 复制后  | ± 5°  
...
## 注释
  ...
  1. [↑](#cite_ref-1) 游戏中这个法术和多重施放类的[四重法术](多重法术.md)重名了。
...
---  
| [](召唤墙壁.md)[](召唤平台.md)[](远距离施放.md)[](传送施放（敌人位置）.md)[](传送施放.md)[](内在施法.md)[](召唤魔杖灵.md)[](##)[](##)[](##)[](##)[](##)[](##)[](##)[](血液魔法.md)[](黄金变力量.md)[](血液变力量.md)[](全知之眼.md)[](置换术.md)[](置换术.md)[](置换术.md)[](置换术.md)[](置换术.md)[](置换术.md)[](魔杖刷新.md)  
---  
