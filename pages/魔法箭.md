...
**来源:** https://noita.wiki.gg/zh/wiki/%E9%AD%94%E6%B3%95%E7%AE%AD
---
...
魔法箭是Noita中的一种投射物[法术](法术.md)

## 效果

发射一枚轨迹略微受重力影响的魔法箭，具有轻微的后坐力和不错的击退效果。可以被视为[火花弹](火花弹.md)的升级版本。 

具有对应的[定时](定时.md)变种和[触发](触发.md)变种。 

## 使用技巧

  * 其不错的属性使其成为一个游戏中相当实用的法术。
  * 触发和定时版本具有更高的法力消耗，但其易于掌控的弹道可以在魔杖法力足够时使其类似[火花弹](火花弹.md)一样适用于各种触发组合。



## 你知道吗？

  * 与[箭矢](箭矢.md)不同，这种魔法箭不会伤到它的施法者。
...
[![](https://noita.wiki.gg/zh/images/Demo_bullet.gif?c03642)](/zh/wiki/File:Demo_bullet.gif)

射击敌人

[![](https://noita.wiki.gg/images/Spelldemo_magic_arrow.gif?bf6a31)](/zh/wiki/File:Spelldemo_magic_arrow.gif)

[](https://noita.wiki.gg/zh/wiki/File%3ASpelldemo%20magic%20arrow.gif)
