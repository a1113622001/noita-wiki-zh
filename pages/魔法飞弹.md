...
这是一种能够制造魔法飞弹的[法术](法术.md)，会沿着释放时的直线高速飞行，并在击中目标时引起爆炸。换言之，这就是Noita中的火箭发射器。 

在新游戏模式下，魔法飞弹的基础版本是初始[法杖](法杖.md)可能携带的法术之一。 

## 使用技巧

  * 魔法飞弹具有较高的理论释放延迟，不过在实战中没有那么明显。由于该法术具有10次的使用限制，往往需要节约使用。
  * 基础魔法飞弹对于游戏前期来说是一个好用的法术，并且非常适合乱序魔杖，魔法飞弹不需要额外的修正也能保证高伤害、打击范围和精准度。它也有大范围的爆炸能力，在开路能力上或许优于[炸弹](炸弹.md)，因为您可以更精确地控制爆炸发生的位置。
  * 大型魔法飞弹和巨型魔法飞弹增强了其威力并增加了释放延迟，魔法飞弹的存在使得乱序魔杖在游戏中后期依旧有着一席之地。如果你已经有一个不错的输出魔杖，那么再多准备一些威力巨大的巨型魔法飞弹作为爆炸用的火箭炮，将会使你的火力覆盖万无一失。
  * 对于这么一个威力巨大但却有次数限制的法术，[无限法术](无限法术.md)就是解除限制的最强的天赋，能够实现真正意义上的火箭地毯式轰炸。同大部分爆炸类的法术一样，使用前还请保证自己拥有回避爆炸伤害的手段！
  * [斥力场](斥力场.md)在射击时会影响您自己的魔法飞弹，可能会导致一种无法被修正的的散射。
  * 魔法飞弹也会受重力影响，在应用[沉重一击](沉重一击.md)时更加明显。
...
[![](https://noita.wiki.gg/zh/images/Demo_rocket_tier_2.gif?83ea5a)](/zh/wiki/File:Demo_rocket_tier_2.gif)

[](https://noita.wiki.gg/zh/wiki/File%3ADemo%20rocket%20tier%202.gif)

大型魔法飞弹

[![](https://noita.wiki.gg/zh/images/Demo_rocket_tier_3.gif?65ec74)](/zh/wiki/File:Demo_rocket_tier_3.gif)

[](https://noita.wiki.gg/zh/wiki/File%3ADemo%20rocket%20tier%203.gif)
